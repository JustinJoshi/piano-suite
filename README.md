...
- A **piano-themed design system** ("the studio"): a dark brass-and-ebony stage by default plus an **Ivory** light theme, five more brand presets, ivory/ebony piano-key buttons, hue-coded Play / Explore / Learn doors, and music motifs (shaded keybeds, staves, bar lines, movement numerals) drawn from theme tokens. The landing page's keybed is playable: click, tap, glissando, or plug in MIDI, and it names the chord you're holding. Pick a theme at `/settings/theme`; the rules live in `DESIGN-PRINCIPLES.md`.

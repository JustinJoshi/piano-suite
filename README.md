...
- A **piano-themed design system** ("the studio"): a dark brass-and-ebony stage by default plus an **Ivory** light theme, five more brand presets, ivory/ebony piano-key buttons, hue-coded Play / Explore / Learn doors, and music motifs (keybeds, staff lines, bar lines, measure numbers) drawn from theme tokens. Pick a theme at `/settings/theme`; the rules live in `DESIGN-PRINCIPLES.md`.

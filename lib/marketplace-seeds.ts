...
export const marketplaceSeeds: MarketplaceSeed[] = [
  ...
  {
    id: "piece-trainer",
    title: "Learn a piece, one section at a time",
    authorName: "Justin",
    authorNote:
      "FOR JUSTIN — rewrite this note in your voice. I put this page together to turn any MIDI file into a practice routine: upload a piece, loop bars 1–4 until they are comfortable, and let the tempo ramp raise the speed a little each run. The falling notes show what is coming; the keyboard underneath rings what you play.",
    blocks: [
      block("pieceLibrary", {
        handFilter: "both",
        role: "graded",
